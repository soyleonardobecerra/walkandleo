...
async function subirAudio() {
    ...
    try {
        ...
        // No bloqueamos audios cortos: en algunos celulares Android/Chrome
        // el primer fragmento puede pesar muy poco aunque el audio sea válido.
        // Solo se rechaza cuando realmente no se generó ningún archivo.
        if (blob.size === 0) {
